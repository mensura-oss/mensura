...
- `services/core`: versioned FastAPI resource contracts, RFC 9457 errors, read-only Git/Vault adapters, bounded Guard runner, in-memory resource storage, and API tests.
