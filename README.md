...
- `services/core`: versioned FastAPI contracts, RFC 9457 errors, read-only Git/Vault adapters, immutable context-pack assembly, bounded Guard runner, deterministic plus optional OpenAI BYOK execution adapters, local credential/config boundaries, in-memory resource storage, and API tests.
